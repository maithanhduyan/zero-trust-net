...
Read [](file:///home/zero-trust-net/control-plane/api/v1/admin.py#1-1), lines 1 to 150

Read [](file:///home/zero-trust-net/control-plane/core/policy_engine.py#1-1), lines 1 to 150

Read [](file:///home/zero-trust-net/policies/global.yaml#1-1), lines 1 to 100

Read [](file:///home/zero-trust-net/policies)

Read [](file:///home/zero-trust-net/control-plane/api/v1/admin.py#151-151), lines 151 to 300

Read [](file:///home/zero-trust-net/policies/roles)

Read [](file:///home/zero-trust-net/scripts)

Searched for regex `hub|control-plane|agent|node` (`**/scripts/**/*.sh`), 20 results

Read [](file:///home/zero-trust-net/policies/roles/app.yaml#1-1), lines 1 to 100

Read [](file:///home/zero-trust-net/policies/roles/database.yaml#1-1), lines 1 to 100

Read [](file:///home/zero-trust-net/control-plane/api/v1/admin.py#301-301), lines 301 to 500

Read [](file:///home/zero-trust-net/scripts/hub/install.sh#1-1), lines 1 to 100

Read [](file:///home/zero-trust-net/scripts/node/install.sh#1-1), lines 1 to 100

Read [](file:///home/zero-trust-net/scripts/policy/apply.sh#1-1), lines 1 to 100

Read [](file:///home/zero-trust-net/control-plane/core/policy_engine.py#150-150), lines 150 to 304

Read [](file:///home/zero-trust-net/control-plane/api/v1/admin.py#500-500), lines 500 to 700

Searched for regex `load.*yaml|parse.*policy|import.*policies`, 9 results

Read [](file:///home/zero-trust-net/infrastructure/ansible/playbook/sync-policies.yml)

Read [](file:///home/zero-trust-net/control-plane/api/v1/admin.py#700-700), lines 700 to 848
...
Read [](file:///home/zero-trust-net/control-plane/api/v1/agent.py#100-100), lines 100 to 250

Read [](file:///home/zero-trust-net/infrastructure/ansible/roles)

Read [](file:///home/zero-trust-net/infrastructure/ansible/inventory/group_vars)
...
Read [](file:///home/zero-trust-net/infrastructure/ansible/inventory/group_vars/hub.yml)

Read [](file:///home/zero-trust-net/infrastructure/ansible/inventory/hosts.ini#1-1), lines 1 to 50

Read [](file:///home/zero-trust-net/scripts/policy/apply.sh#100-100), lines 100 to 254
